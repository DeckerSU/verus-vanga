...
INC = -Iinclude
CFLAGS = -Wall -std=c++0x -mavx2 -maes -fpermissive
RESINC = 
LIBDIR = -Llib
...
DEP_DEBUG = 
OUT_DEBUG = bin/Debug/verus_vanga
...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/verus_vanga

OBJ_DEBUG = $(OBJDIR_DEBUG)/haraka.o $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/mini-gmp.o $(OBJDIR_DEBUG)/stuff.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/haraka.o $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/mini-gmp.o $(OBJDIR_RELEASE)/stuff.o
...
$(OBJDIR_DEBUG)/mini-gmp.o: mini-gmp.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c mini-gmp.c -o $(OBJDIR_DEBUG)/mini-gmp.o
...
$(OBJDIR_RELEASE)/mini-gmp.o: mini-gmp.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c mini-gmp.c -o $(OBJDIR_RELEASE)/mini-gmp.o
